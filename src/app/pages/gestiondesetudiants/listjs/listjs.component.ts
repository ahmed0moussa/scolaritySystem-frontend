...
export class ListjsComponent {
  ...
  constructor(public service: ListService, private formBuilder: UntypedFormBuilder, private pipe: DecimalPipe,private etudiantService:EtudiantService,private toastr:ToastrService) {
   ...
   */
    this.listJsForm = this.formBuilder.group({
      ...
      mail: ['', [Validators.required, Validators.email,this.emailPatternValidator()]],
      age: ['', Validators.required],
      cin: ['', Validators.required],
      adresse: ['', Validators.required],
      gsm: ['', Validators.required],
      parent: ['', Validators.required],
      telParent: ['', Validators.required],
      emailParent: ['', [Validators.required, Validators.email,this.emailPatternValidator()]],
      dateN: ['', Validators.required],
      lienN: ['', Validators.required],
  ...
  saveListJs() {
    ...
    if (this.listJsForm.valid) {
      ...
      if (formData.ids) {
        ...
        this.etudiantService.updateEtudiant(formData.ids, formData).subscribe(
          () => {
            console.log('etudiant updated successfully', formData);
            this.toastr.success('etudiant modifié avec succès!', 'Success');
            this.findall();
          },
          (error) => {
    ...
    if (id) {
      ...
      this.etudiantService.deleteEtudiant(id).subscribe(
        () => {
          ...
          this.toastr.success('etudiant deleted successfully', 'Success');
          this.findall();
        },
        (error) => {
